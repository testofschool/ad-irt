...
\paragraph{Data and code.} All data is from the public Evo-SOTA.io repository~\citep{evosota2026}. The supplementary archive includes the complete parsing script, frozen score matrix, fold assignments, fold-level results, and experiment code. Code and data: \url{https://github.com/testofschool/ad-irt}. Zenodo: \url{https://doi.org/10.5281/zenodo.20277641}
